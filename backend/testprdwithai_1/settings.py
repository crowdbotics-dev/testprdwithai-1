"""
Django settings for testprdwithai_1 project.
...
ROOT_URLCONF = 'testprdwithai_1.urls'
...
WSGI_APPLICATION = 'testprdwithai_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testprdwithai_1 API",
    "DESCRIPTION": "API documentation for testprdwithai_1 App",
    "VERSION": "v1",
}
